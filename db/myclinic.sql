...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Jun 2021 pada 07.37
...
(1, 'BR0001', '111111', 'Amoxilin', 1, 1, 11, 2, 3, 1000, 1000, 0, 2000, 110, 10, 100, 1),
(2, 'BR0002', '222222', 'Asam Mefenamat', 1, 1, 11, 2, 3, 2000, 2000, 0, 3000, 150, 10, 100, 1),
(3, 'BR000003', '333333', 'Bodrex', 1, 1, 11, 2, 3, 1000, 1000, 10, 0, 70, 10, 100, 1),
(4, 'BR000004', '444444', 'Paracetamol', 4, 1, 11, 2, 3, 6000, 6000, 20, 0, 100, 10, 100, 1),
(5, 'BR000005', '555555', 'Sanmol Drop', 1, 1, 10, 2, 3, 5000, 5000, 20, 0, 90, 10, 100, 1),
(6, 'BR000006', '666666', 'Panadol', 1, 1, 13, 2, 5, 5000, 5000, 25, 0, 90, 10, 100, 1),
(7, 'BR000007', 'BR000007', 'Konidin', 2, 1, 12, 2, 0, 1000, 1000, 20, 0, 50, 10, 100, 1),
(8, 'BR000008', '888888', 'Kursi Roda', 4, 3, 7, 2, 0, 9000000, 9000000, 0, 15000000, 1, 1, 10, 1),
(9, 'BR000009', 'BR000009', 'Konidin Box', 1, 1, 8, 2, 3, 10000, 10000, 20, 0, 100, 10, 100, 1);
...
('BN', 'BANK', 3),
('BR', 'BARANG', 10),
('CT', 'CATATAN TERINTEGRASI (SOAP)', 32),
('DS', 'DISTRIBUTOR', 4),
('DX', 'PEMBAYARAN TRANSAKSI', 73),
('ET', 'ETIKET', 6),
('GL', 'GOLONGAN', 5),
('GR', 'GROUP', 5),
('JM', 'JAMINAN', 5),
...
('LY', 'LAYANAN', 8),
('OP', 'ORDER PIUTANG', 12),
('PB', 'PEMBELIAN BARANG', 13),
('PG', 'PEGAWAI', 4),
('PJ', 'PENJUALAN BARANG', 94),
('PP', 'PELUNASAN PIUTANG', 6),
('PT', 'PIUTANG', 1),
('RC', 'REKAP CETAK', 7),
('RCK', 'RACIK', 62),
('RG', 'REGISTER', 79),
...
(1, 'PT00000001', '2021-06-23', 4, 83, 571000, 571000, 0);
...
(3, 'OP00000002', 4, 1105010, '2021-05-19', 0, '0000-00-00', 1),
(4, 'OP00000003', 1, 390000, '2021-05-19', 0, '0000-00-00', 1),
(5, 'OP00000004', 1, 382000, '2021-05-19', 0, '0000-00-00', 1),
(6, 'OP00000005', 1, 50000, '2021-05-19', 0, '0000-00-00', 1),
(7, 'OP00000006', 1, 1784205, '2021-05-20', 0, '2021-05-20', 1),
(9, 'OP00000008', 1, 421000, '2021-06-16', 0, '0000-00-00', 1),
(10, 'OP00000009', 1, 510000, '2021-06-16', 0, '0000-00-00', 1),
(11, 'OP00000010', 4, 1742000, '2021-06-17', 8, '0000-00-00', 1),
(12, 'OP00000011', 4, 300000, '2021-06-17', 9, '0000-00-00', 1);
...
INSERT INTO `t_trs_order_piutang_cart` (`fs_id_cart_order_piutang`, `fs_id_regout2`, `fs_id_registrasi`, `fn_nilai_piutang`, `fs_id_order_piutang`, `fs_id_user`) VALUES
(1, 1, 83, 571000, 0, 1);
...
INSERT INTO `t_trs_order_piutang_detail` (`fs_id_order_piutang_detail`, `fs_id_order_piutang`, `fs_id_regout2`, `fs_id_registrasi`, `fn_nilai_piutang`) VALUES
(3, 3, 0, 69, 595130),
(4, 3, 0, 67, 509880),
(5, 4, 0, 71, 390000),
(6, 5, 0, 70, 382000),
...
(8, 'PP00000004', 4, 11, 7, 1742000, 0, 1742000, '2021-06-17', '0000-00-00', 1),
(9, 'PP00000005', 4, 12, 3, 300000, 0, 300000, '2021-06-17', '0000-00-00', 1);
...
(63, 81, 647950, 247950, '2021-06-22', 1),
...
(74, 'DX00000071', 65, 83, 0, 0, 0, 0, 0, 0, 0, 4, 571000, 0, '2021-06-23', 0),
...
--
ALTER TABLE `tb_trs_pembelian`
  MODIFY `fs_id_pembelian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `tb_trs_pembelian_detail`
--
ALTER TABLE `tb_trs_pembelian_detail`
  MODIFY `fs_id_pembelian_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT untuk tabel `tb_trs_penjualan`
--
ALTER TABLE `tb_trs_penjualan`
  MODIFY `fs_id_penjualan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;

--
-- AUTO_INCREMENT untuk tabel `tb_trs_penjualan_detail`
--
ALTER TABLE `tb_trs_penjualan_detail`
  MODIFY `fs_id_penjualan_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=253;

--
-- AUTO_INCREMENT untuk tabel `tb_trs_racik`
--
ALTER TABLE `tb_trs_racik`
  MODIFY `fs_id_racik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;

--
-- AUTO_INCREMENT untuk tabel `tb_trs_racik_detail`
--
ALTER TABLE `tb_trs_racik_detail`
  MODIFY `fs_id_racik_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
...
--
ALTER TABLE `t_piutang`
  MODIFY `fs_id_piutang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `t_soap`
  MODIFY `fs_id_soap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `t_trs_billing`
  MODIFY `fs_id_trs_billing` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=231;

--
-- AUTO_INCREMENT untuk tabel `t_trs_order_piutang`
--
ALTER TABLE `t_trs_order_piutang`
  MODIFY `fs_id_order_piutang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT untuk tabel `t_trs_order_piutang_detail`
--
ALTER TABLE `t_trs_order_piutang_detail`
  MODIFY `fs_id_order_piutang_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT untuk tabel `t_trs_pelunasan_piutang`
--
ALTER TABLE `t_trs_pelunasan_piutang`
  MODIFY `fs_id_pelunasan_piutang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT untuk tabel `t_trs_pelunasan_piutang_detail`
--
ALTER TABLE `t_trs_pelunasan_piutang_detail`
  MODIFY `fs_id_pelunasan_piutang_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT untuk tabel `t_trs_registrasi`
--
ALTER TABLE `t_trs_registrasi`
  MODIFY `fs_id_registrasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;

--
-- AUTO_INCREMENT untuk tabel `t_trs_regout`
--
ALTER TABLE `t_trs_regout`
  MODIFY `fs_id_regout` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;

--
-- AUTO_INCREMENT untuk tabel `t_trs_regout2`
--
ALTER TABLE `t_trs_regout2`
  MODIFY `fs_id_regout2` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;

--
-- AUTO_INCREMENT untuk tabel `t_trs_tindakan`
--
ALTER TABLE `t_trs_tindakan`
  MODIFY `fs_id_trs_tindakan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;

--
-- AUTO_INCREMENT untuk tabel `t_trs_tindakan2`
--
ALTER TABLE `t_trs_tindakan2`
  MODIFY `fs_id_tindakan2` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=210;
