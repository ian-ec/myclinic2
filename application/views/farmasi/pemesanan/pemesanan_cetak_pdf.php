    ...
    <div class="content">
        ...
        <div class="pemesanan">
            <table class="transaction-table" cellspacing="5" cellpadding="0">
                <tbody>
                    <tr>
                        <td style="width: 20%;">Kode pemesanan</td>
                        <td style="width: 1%;">:</td>
                        <td><strong><?= $pemesanan->fs_kd_pemesanan ?></strong></td>
                        <td style="width: 20%;">Distributor</td>
                        <td style="width: 1%;">:</td>
                        <td><strong><?= $pemesanan->fs_nm_distributor ?></strong></td>
                    </tr>
                    <tr>
                        <td style="width: 20%;">Tanggal Transaksi</td>
                        <td style="width: 1%;">:</td>
                        <td><strong><?= indo_date($pemesanan->fd_tgl_pemesanan) ?></strong></td>
                        <td style="width: 20%;">Alamat</td>
                        <td style="width: 1%;">:</td>
                        <td><strong><?= $pemesanan->fs_alamat_distributor ?></strong></td>
                    </tr>
                    <tr>
                        <td style="width: 20%;">Layanan Order</td>
                        <td style="width: 1%;">:</td>
                        <td><strong><?= $pemesanan->fs_nm_layanan ?></strong></td>
                        <td style="width: 20%;">Telp</td>
                        <td style="width: 1%;">:</td>
                        <td><strong><?= $pemesanan->fs_telp_distributor ?></strong></td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <table cellspacing="5" cellpadding="0">
            <tbody style="text-align: right;">
                <tr>
                    <td colspan="9" rowspan="3" align="left" valign="top"><strong> Note: <br> <?= $pemesanan->fs_keterangan ?></strong></td>
                    <td>Subtotal</td>
                    <td style="width: 1%;">:</td>
                    <td style="width: 10%;"><?= indo_currency2($pemesanan->fn_subtotal) ?></td>
                </tr>
                <tr>
                    <td>Diskon</td>
                    <td>:</td>
                    <td><?= indo_currency2($pemesanan->fn_diskon) ?></td>
                </tr>
                <tr>
                    <td>Grand Total</td>
                    <td>:</td>
                    <td><?= indo_currency2($pemesanan->fn_grandtotal) ?></td>
                </tr>
                <tr>
                    <td colspan="12"><br></td>
                </tr>
                <tr>
                    ...
                    <td colspan="3" align="center">
                        ...
                        <br>
                        <br>
                        <b><u>(<?= ucfirst($pemesanan->name) ?>)</u></b>
                    </td>
                </tr>
            </tbody>
        </table>
