    ...
    <div class="content">
        ...
        <div class="adjustment">
            <table class="transaction-table" cellspacing="5" cellpadding="0">
                <tbody>
                    <tr>
                        <td style="width: 20%;">Kode adjustment</td>
                        <td style="width: 1%;">:</td>
                        <td><strong><?= $adjustment->fs_kd_adjustment ?></strong></td>
                        <td style="width: 20%;">Petugas</td>
                        <td style="width: 1%;">:</td>
                        <td><strong><?= ucfirst($adjustment->name) ?></strong></td>
                    </tr>
                    <tr>
                        <td style="width: 20%;">Disetujui</td>
                        <td style="width: 1%;">:</td>
                        <td><strong><?= $adjustment->fs_nm_pegawai ?></strong></td>
                        <td style="width: 20%;">Tgl Transaksi</td>
                        <td style="width: 1%;">:</td>
                        <td><strong><?= indo_date($adjustment->fd_tgl_adjustment) ?></strong></td>
                    </tr>
                </tbody>
            </table>
        </div>
        <div class="transaction">
            <table class="transaction-table" cellspacing="5" cellpadding="0">
                ...
                <tbody>
                    <?php
                    $no = 1;
                    foreach ($adjustment_detail as $key => $data) { ?>
                        <tr>
        ...
        <table rules="" cellspacing="5" cellpadding="0">
            <tbody style="text-align: right;">
                <tr>
                    <td align="left" valign="top"><strong> Note: <br> <?= $adjustment->fs_keterangan ?></strong></td>
                    <td>Grand Total : <?= indo_currency2($adjustment->fn_total_nilai_beli) ?></td>
                </tr>
                <tr>
