        ...
        <div class="card">
            <div class="card-body">
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-8">
                        <input type="date" id="fd_tgl_trs" value="<?= $row->fd_tgl_trs ?>" class="form-control">
                    </div>
                </div>
                <div class="form-group row mb-2">
                    <label class="col-sm-4 col-form-label text-right">Kode Tindakan</label>
                    <div class="col-sm-8">
                        <input type="hidden" id="fs_id_trs_tindakan" value="<?= $row->fs_id_trs_tindakan ?>">
                        <input type="text" style="background-color: lavender;" id="fs_kd_trs_tindakan" value="<?= $row->fs_kd_trs_tindakan ?>" class="form-control" readonly>
                    </div>
                </div>
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-8 input-group">
                        ...
                        <input type="text" style="background-color: lavender;" class="form-control" id="fs_kd_registrasi" value="<?= $row->fs_kd_registrasi ?>" readonly>
                    </div>
                </div>
                <div class="form-group row mb-2">
                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-8">
                        <input type="text" style="background-color: lavender;" id="fs_nm_jaminan" value="<?= $row->fs_nm_jaminan ?>" class="form-control" readonly>
                    </div>
                </div>
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-8 input-group">
                        ...
                        <input type="text" style="background-color: lavender;" id="fs_nm_layanan" value="<?= $row->fs_nm_layanan ?>" class="form-control" readonly>
                ...
                <div class="form-group row mb-2">
                    <label class="col-sm-4 col-form-label text-right"></label>
                    <div class="col-sm-8">
                        <button type="button" id="simpan_editan" class="btn btn-flat btn-success" style="width: 100%;">
...
<script>
    ...
    $(document).on('click', '#edit_cart', function() {
        ...
        var fs_id_tindakan = $('#fs_id_trs_tindakan').val()
        var fn_qty = $('#qty').val()
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.success == true) {
                        $('#cart_table').load('<?= site_url('tindakan/cart_data_edit/') ?>' + fs_id_tindakan, function() {
                            calculate()
                        })
                        Swal.fire({
                            icon: 'success',
    ...
    $(document).on('click', '#simpan_editan', function() {
        var fs_id_registrasi = $('#fs_id_registrasi').val()
        var fs_id_tindakan = $('#fs_id_trs_tindakan').val()
        var fs_kd_trs_tindakan = $('#fs_kd_trs_tindakan').val()
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        data: {
                            ...
                            'fs_id_tindakan': fs_id_tindakan,
                            'fs_kd_trs_tindakan': fs_kd_trs_tindakan,
