...
<!-- Mirrored from themesbrand.com/skote/layouts/vertical/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Nov 2020 03:24:23 GMT -->

<head>

  <meta charset="utf-8" />
  <title><?= $parameter->aplication_name ?> | Log in</title>
  ...
  <!-- Bootstrap Css -->
  <link href="<?= base_url() ?>assets/plugins/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
  <!-- Icons Css -->
  <link href="<?= base_url() ?>assets/plugins/css/icons.min.css" rel="stylesheet" type="text/css" />
  <!-- App Css-->
  <link href="<?= base_url() ?>assets/plugins/css/app.min.css" id="app-style" rel="stylesheet" type="text/css" />
              ...
              <div class="row">
                <div class="col-7">
                  <div class="text-primary p-4">
                    <h5 class="text-primary"><?= $parameter->aplication_name ?></h5>
                    <p>Silahkan login dahulu...!!!</p>
                  </div>
                </div>
                <div class="col-5 align-self-end">
                  <img src="<?= base_url() ?>assets/plugins/images/profile-img.png" alt="" class="img-fluid">
                </div>
              </div>
            </div>
                ...
                <a href="index.html">
                  <div class="avatar-md profile-user-wid mb-4">
                    <span class="avatar-title rounded-circle bg-light">
                      <img src="<?= base_url() ?>assets/plugins/images/logo.svg" alt="" class="rounded-circle" height="34">
                    </span>
                  </div>
                </a>
              </div>
              <div class="p-2">
                <form class="form-horizontal" action="<?= base_url('auth/process') ?>" method="post">
